...
def render_assignment_answers(
    ...
    """Render explicit, auditable answers to assignment questions.

    Pages use this component after their result section so users do not need to
    infer conclusions from charts alone. Each answer names the assignment item,
    states a conclusion, and optionally cites the result table or model check
